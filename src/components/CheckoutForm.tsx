    ...
    <form onSubmit={onSubmit} className="mt-8 grid gap-8 lg:grid-cols-[1fr_340px]">
      <div className="flex flex-col gap-7">
        <fieldset className="flex flex-col gap-4">
          ...
          <div>
            <label className={label} htmlFor="email">{t.checkout.email} <span className="normal-case tracking-normal">({t.common.optional})</span></label>
        ...
        <div>
          <label className={label} htmlFor="qeyd">{t.checkout.note} <span className="normal-case tracking-normal">({t.common.optional})</span></label>
      ...
      <aside className="h-fit rounded-2xl border border-line bg-surface p-6 lg:sticky lg:top-24">
        ...
        <dl className="mt-4 flex flex-col gap-2 text-[15px]">
          ...
          <div className="flex justify-between"><dt className="text-ink-muted">{t.common.delivery}</dt><dd className="tabular-nums">{fee === 0 ? t.common.free : money(fee)}</dd></div>

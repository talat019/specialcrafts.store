      ...
      <header className="border-b border-line bg-surface">
        <div className="mx-auto flex max-w-[1240px] flex-wrap items-center justify-between gap-4 px-5 py-3.5 lg:px-8">
          <div className="flex items-center gap-6">
            <Link href="/admin" className="font-display text-[18px]">
              special crafts <span className="text-ink-faint">admin</span>
            </Link>
          ...
          <div className="flex items-center gap-4 text-[13.5px]">
            <Link href="/az" className="text-ink-muted hover:text-ink">Sayta bax →</Link>
